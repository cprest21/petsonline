...
class TreatmentsControllerTest < ActionController::TestCase
  ...
  test "should create treatment" do
    assert_difference('Treatment.count') do
      post :create, treatment: { treatment_date: @treatment.treatment_date, veterinarian_id: @treatment.veterinarian_id }
    end
  ...
  test "should update treatment" do
    patch :update, id: @treatment, treatment: { treatment_date: @treatment.treatment_date, veterinarian_id: @treatment.veterinarian_id }
    assert_redirected_to treatment_path(assigns(:treatment))
  end
