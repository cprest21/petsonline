...
class AdvertisersControllerTest < ActionController::TestCase
  ...
  test "should create advertiser" do
    assert_difference('Advertiser.count') do
      post :create, advertiser: { address_id: @advertiser.address_id, lastname: @advertiser.lastname, name: @advertiser.name, user_id: @advertiser.user_id }
    end
  ...
  test "should update advertiser" do
    patch :update, id: @advertiser, advertiser: { address_id: @advertiser.address_id, lastname: @advertiser.lastname, name: @advertiser.name, user_id: @advertiser.user_id }
    assert_redirected_to advertiser_path(assigns(:advertiser))
  end
