...
class AdvertisementsControllerTest < ActionController::TestCase
  ...
  test "should create advertisement" do
    assert_difference('Advertisement.count') do
      post :create, advertisement: { details: @advertisement.details, placement_date: @advertisement.placement_date, user_id: @advertisement.user_id }
    end
  ...
  test "should update advertisement" do
    patch :update, id: @advertisement, advertisement: { details: @advertisement.details, placement_date: @advertisement.placement_date, user_id: @advertisement.user_id }
    assert_redirected_to advertisement_path(assigns(:advertisement))
  end
